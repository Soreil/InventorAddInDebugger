...
internal class AddInLoader
{
    ...
    /// </summary>
    public static string AddInAssemblyFile => Config.AddInAssemblyFile;

    /// <summary>
    /// Gets the ClientId of the original AddIn
    /// </summary>
    public static string AddInClientId => Config.AddInClientId;
    ...
    /// Error shown in the UI of Inventor if called repeatedly
    /// </summary>
    ...
    private static List<AddInInfo> GetAddInsFromAssembly(string lastBuild)
    {
    ...
    private static string SearchLastBuild(string buildDir, string dllFileName)
    {
