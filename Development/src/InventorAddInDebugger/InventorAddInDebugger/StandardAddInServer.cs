...
public class StandardAddInServer : ApplicationAddInServer
{
    ...
    {
        Debug.Assert(_activateAddInCmd is not null);
        Debug.Assert(_deactivateAddInCmd is not null);
        Debug.Assert(_reloadAddInCmd is not null);
        Debug.Assert(_openBuildFolderCmd is not null);
        Debug.Assert(_attachDebuggerCmd is not null);
        Debug.Assert(_settingsCmd is not null);
        Debug.Assert(_aboutCmd is not null);
    ...
    private void CreateCommands()
    {
        ...
        Debug.Assert(_inventor is not null);
        Debug.Assert(_addInLoader is not null);
        ...
        Debug.Assert(_configMgr is not null);
